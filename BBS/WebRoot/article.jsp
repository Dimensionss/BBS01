...
<%!
    private static void tree(List<Article> articles,Connection conn,int id,int grade){
              ...
              <table summary="List of threads" cellpadding="0" cellspacing="0" width="100%">
                ...
                <%
                    for(Iterator<Article> it= articles.iterator();it.hasNext();){
                           Article a=it.next();
                           String preS="";
                           for(int i=0;i<a.getGrade();i++)preS+="---";
                 %>
                  <tr class="jive-even">
                    ...
                    <a href="delete.jsp?id=<%=a.getId() %>&pid=<%=a.getPid() %>&isLeaf=<%=a.isLeaf()%>">删除</a>
                    </td>
                    <td class="jive-thread-name" width="95%"><a id="jive-thread-1" href="articleDetail.jsp?id=<%=a.getId() %>"><%=preS+a.getTitle() %></a></td>
